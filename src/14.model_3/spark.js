...
export default class Spark {
  constructor(gl, pos = [0, 0], velocity = 10, direct = 0, lifespan = 25, thickness = 3, friction = 0.94) {
    this.options = {
      pos,
      velocity,
      direct,
    ...
    //this.shader = modelShader(gl);
    //this.bufferData = modelBuffers(gl);
    this.init();
  }
  init() {
  ...
  update(delta) {
    ...
    VectorE.add(this.velocityPos, Vector.add(this.options.gravity, [0, -0.6]));
